      ...
      <div class="content-r">
        <div class="custom-page-view-search" ref="search">
          ...
          <div class="current_location">
            当前位置：<span>{{ currentItem.name || '部位' }}</span>
        ...
        <div class="custom-page-view-table" v-if="exhibition">
          <a-form :form="form">
            ...
            <a-form-item :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }" label="部位名称" class="bg">
              <a-input v-model="currentItem.name" />
            </a-form-item>
            <a-form-item :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }" label="部位介绍">
        ...
        <div class="custom-page-view-table" v-if="addexhibition">
          <a-form :form="form">
            <a-form-item class="bg" :label-col="{ span: 8 }" :wrapper-col="{ span: 16 }" label="部位名称">
